...
class CssWriter {
        ...
        JSON.stringify(
          {
            version: 3,
            file: basename,
            sources: this.map.sources.map(source =>
  ...
  toString() {
    this.warn(
      '[DEPRECATION] As of rollup-plugin-svelte@3, the argument to the `css` function is an object, not a string — use `css.write(file)`. Consult the documentation for more information: https://github.com/rollup/rollup-plugin-svelte',
    );
    return this.code;
  }
}
...
module.exports = function svelte(options = {}) {
  ...
  let css =
    options.css && typeof options.css === 'function' ? options.css : null;
